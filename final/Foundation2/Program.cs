...
class Program
{
    static void Main(string[] args)
    {
        ...
        // Second Order
        Product product3 = new Product("Product one", 1, 10.25, 2);
        productListOrd2.Add(product3);
        Product product4 = new Product("Product two", 2, 5.25, 3);
        productListOrd2.Add(product4);
        Product product5 = new Product("Product two", 2, 5.25, 3);
        productListOrd2.Add(product5);
        Address address2 = new Address("110 Break Olive st", "Irvine", "CA", "VZLA");
